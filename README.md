...
| `SendI2C`/`ReceiveI2C` (Aminet `docs/hard/i2clib40`) | Exercises the PCF8574's GPIO *write* path, not just reads: `SendI2C` writes a distinct byte (0xA5) to its output latch, `ReceiveI2C` reads it straight back |
