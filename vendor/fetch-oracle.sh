...
[ -e "$I2CS/Sensors/BMP280.cfg" ] || curl -sL -o "$I2CS/Sensors/BMP280.cfg" "$BASE/sensors/devs/Sensors/BMP280.cfg"
[ -e "$I2CS/Sensors/BME680.cfg" ] || curl -sL -o "$I2CS/Sensors/BME680.cfg" "$BASE/sensors/devs/Sensors/BME680.cfg"
[ -e "$I2CS/Sensors/AM2320.cfg" ] || curl -sL -o "$I2CS/Sensors/AM2320.cfg" "$BASE/sensors/devs/Sensors/AM2320.cfg"
